...
`timescale 1ns / 1ps
module exp_fix_2 // #(parameter wA_BIN=8, wA_IND=8, vMAX=2**16-1)
// wT - numenator width
	(
	...
	output logic [15:0] Y_FIX_2,
	output logic END_FLAG_2
	);
...
// initializing LUTs
initial begin
	$readmemb("template_lut_15_2_e_0.6x.mem", bin_lut);
	$readmemb("scaling_lut_15_2_e_0.6x.mem", exp_lut);
end
